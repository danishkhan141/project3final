...
public class UserRegistrationCtl extends BaseCtl {
	...
	request.setAttribute("lastName", PropertyReader.getValue("error.alphabet", "Last name"));
		...
		/*
		 * if (DataValidator.isNull(email)) { request.setAttribute("email",
		 * PropertyReader.getValue("error.require", "Email id")); pass = false; } else
		 * if (!DataValidator.isEmail(email)) { request.setAttribute("email",
		 * PropertyReader.getValue("error.email", "Email id")); pass = false;
		 * 
		 * } if (DataValidator.isNull(request.getParameter("password"))) {
		 * request.setAttribute("password", PropertyReader.getValue("error.require",
		 * "Password")); pass = false; } else if
		 * (!DataValidator.isPasslength(request.getParameter("password"))) {
		 * request.setAttribute("password", PropertyReader.getValue("error.pwdlength",
