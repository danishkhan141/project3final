...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("<P><B>Login Id : " + map.get("email") + "<BR>" + " Password : " + map.get("password") + "</B></p>");
	...
	public static String getForgetPasswordMessage(HashMap<String, String> map) {
		 ...
		 */
		msg.append("<P><B>To access your account please use below credentials: " + "<BR>" + " Email Id : "
				+ map.get("email") + "<BR>" + " Password : " + map.get("password") + "</B></p>");
		msg.append("</BODY></HTML>");
	...
	public static String getChangePasswordMessage(HashMap<String, String> map) {
		 ...
		 * " and password " + map.get("password") + "</P>");
		 */
		msg.append("<P><B>To access your account please use below credentials: " + map.get("email") + "<BR>"
