...
<body>
	...
	<div class="header">
		<nav class="navbar navbar-dark bg-dark navbar-expand">
			...
			<a class="navbar-brand mb-0 h1 border-md-right"
				href="<%=ORSView.WELCOME_CTL%>"> <img
				src="<%=ORSView.APP_CONTEXT%>/img/main_logo.png" alt="Rays"
				height="25" href="#"> Welcome
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="nav navbar-nav mr-auto">
					...
					<li class="nav-item dropdown" style="padding-left: 5px;"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<%=ORSView.USER_CTL%>"><i
								...
								href="<%=ORSView.USER_LIST_CTL%>"><i class="fas fa-users"></i>
								User List</a>
						</div></li>
					...
					<li class="nav-item dropdown" style="padding-left: 5px"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<%=ORSView.COURSE_CTL%>"><i
								class="fas fa-book-open"></i> Add Course</a> <a
								class="dropdown-item" href="<%=ORSView.COURSE_LIST_CTL%>"><i
					...
					<li class="nav-item dropdown" style="padding-left: 5px"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<%=ORSView.SUBJECT_CTL%>"><i
								class="fas fa-book"></i> Add Subject</a> <a class="dropdown-item"
					...
					<li class="nav-item dropdown" style="padding-left: 5px"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<%=ORSView.FACULTY_CTL%>"><i
								class="fas fa-chalkboard-teacher"></i> Add Faculty</a> <a
								class="dropdown-item" href="<%=ORSView.FACULTY_LIST_CTL%>"><i
								class="	fas fa-user-tie"></i> Faculty List</a>
						</div></li>
					...
					<li class="nav-item dropdown" style="padding-left: 5px"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<%=ORSView.MARKSHEET_CTL%>"><i
								...
								class="fas fa-paste"></i> Marksheet List</a> <a
								class="dropdown-item"
					...
					<li class="nav-item dropdown border-md-right"
						style="padding-left: 5px;"><a class="nav-link"
						href="<%=ORSView.JAVA_DOC_VIEW%>" role="button"
						aria-haspopup="true" aria-expanded="false" target="blank"> <font
							style="color: white;">Java Doc</font>
					</a></li>
					<%
						}
						}
					...
					<li class="nav-item dropdown" style="padding-left: 5px;"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false"> <font style="color: white;"><%=welcomeMsg%></font></a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">

							<a class="dropdown-item"
								href="<%=ORSView.LOGIN_CTL%>?operation=<%=LoginCtl.OP_LOG_OUT%>">
								<i class="fas fa-sign-out-alt"></i> Logout
							</a> <a class="dropdown-item" href="<%=ORSView.MY_PROFILE_CTL%>"><i
					...
					<li class="nav-item dropdown" style="padding-left: 5px;"><a
						class="nav-link" href="<%=ORSView.LOGIN_CTL%>" role="button"
						aria-haspopup="true" aria-expanded="false"> <i
							class="fas fa-sign-in-alt"></i> <font style="color: white;">
								Login</font>
					</a></li>

					<li class="nav-item dropdown border-md-right"
						style="padding-left: 10px; padding-right: 19cm;"><a
						class="nav-link" href="<%=ORSView.USER_REGISTRATION_CTL%>"
						role="button" aria-haspopup="true" aria-expanded="false"> <i
							class="fas fa-registered"></i> <font style="color: white;">
								User Registration</font>
					</a></li>

					<li class="nav-item dropdown active" style="padding-left: 5px;">
						<a class="nav-link" aria-haspopup="true" aria-expanded="false">
							<i class="fas fa-user"></i> <font style="color: white;"> <%=welcomeMsg%></font>
					</a>
					</li>
					<%
						}
