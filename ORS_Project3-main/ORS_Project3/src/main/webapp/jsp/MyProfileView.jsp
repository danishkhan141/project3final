<%@page import="com.sunilOS.ORSProject3.ctl.MyProfileCtl"%>
            ...
            <div class="card" style="border-radius: 2rem;">
              <div class="card-body p-5">
                  ...
                  <div class="text-cente">
                    <h4 style="text-shadow:black;"><u><b>My Profile</b></u></h4>
                  </div>
...
<%
        ...
        <div class="input-group">
        	<div class="input-group-prepend">
        	  ...
        	  <input type="text" class="form-control" name="email" readonly="readonly" value="<%=DataUtility.getStringData(dto.getEmail())%>">
        </div>
			...
			<%=HTMLUtility.getList("gender", dto.getGender(), genMap, "Select Gender")%>
         	...
         	<font color="red" style="padding-right: 5cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("gender", request)%></font>
               ...
               <br>
                    ...
                    <input type="submit" class="btn btn-secondary" name="operation" value="<%=MyProfileCtl.OP_CHANGE_MY_PASSWORD%>">
                  </div>
