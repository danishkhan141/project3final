...
<style>
.p1 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/366327.jpg');
	background-size: 100%;
}
...
<body class="p1">
	<form action="<%=ORSView.TIMETABLE_CTL%>" method="post">
		<jsp:useBean id="dto" class="com.sunilOS.ORSProject3.dto.TimeTableDTO"
			...
			<center>
				...
				<div class="container">
								...
								<div class="card-body p-5">
									...
									<div class="text-center">
										...
										<h4 style="text-shadow: black;">
											<u><b>UPDATE TIME TABLE</b></u>
										</h4>
										<%
											} else {
										%>
										<h4 style="text-shadow: black;">
											<u><b>ADD TIME TABLE</b></u>
										</h4>
										<%
											}
										%>
									...
									<br> <br> <span style="padding-right: 6.8cm;"><b>Course</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-book-open grey-text" style="font-size: 1rem;"></i></span>
										</div>
					...
					"Select Course Name")%>
									...
									<br> <span style="padding-right: 6.7cm;"><b>Subject</b><span
										style="color: red;">*</span></span> <br>

									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-book grey-text" style="font-size: 1rem;"></i></span>
										</div>
					...
					"Select Subject Name")%>
									...
									<br> <span style="padding-right: 6.5cm;"><b>Semester</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fas fa-hourglass-half grey-text"
									...
									<font color="red"
										style="padding-right: 4.8cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("semesterId", request)%></font>

									<br> <span style="padding-right: 6.4cm;"><b>Exam
											Date</b><span style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
										...
										<input type="date" class="form-control" name="examDate"
											value="<%=DataUtility.getDateToString(dto.getExamDate())%>">
									</div>
									<font color="red"
										style="padding-right: 4.7cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("examDate", request)%></font>

									<br> <span style="padding-right: 6.2cm;"><b>Exam
											Time</b><span style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-clock grey-text" style="font-size: 1rem;"></i></span>
										</div>
										<%
									...
									<font color="red"
										style="padding-right: 4.4cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("examTime", request)%></font>

									<br> <span style="padding-right: 6.4cm;"><b>Description</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-info-circle grey-text" style="font-size: 1rem;"></i></span>
										</div>
									...
									<font color="red"
										style="padding-right: 4.8cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("description", request)%></font>
