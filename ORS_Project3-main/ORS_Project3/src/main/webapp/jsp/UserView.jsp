						...
						<div class="col-12 col-md-8 col-lg-6">
							<div class="card" style="border-radius: 2rem;">
								<div class="card-body p-5">
									...
									<br> <br> <span style="padding-right: 6.5cm;"><b>First
									...
									<br> <span style="padding-right: 7.2cm;"><b>Role</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fas fa-user-tag grey-text" style="font-size: 1rem;"></i></span>
										</div>
									...
									<br> <span style="padding-right: 6.8cm;"><b>Gender</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-venus-mars grey-text" style="font-size: 1rem;"></i></span>
										</div>
										<%
