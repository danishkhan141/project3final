...
<body class="p1">
	<form action="<%=ORSView.COLLEGE_CTL%>" method="post">
		<jsp:useBean id="dto" class="com.sunilOS.ORSProject3.dto.CollegeDTO"
						...
						<div class="col-12 col-md-8 col-lg-6">
							<div class="card" style="border-radius: 2rem;">
								<div class="card-body p-5">
									...
									<br> <br> <span style="padding-right: 5.7cm;"><b>College
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="collegeName"
											...
											value="<%=DataUtility.getStringData(dto.getCollegeName())%>">
									</div>
									<font color="red"
										style="padding-right: 4.3cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("collegeName", request)%></font>
									<br> <span style="padding-right: 6.7cm;"><b>Address</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-map-marked grey-text" style="font-size: 1rem;"></i></span>
										</div>
									...
									<font color="red"
										style="padding-right: 5.2cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("address", request)%></font>

									<br> <span style="padding-right: 7.8cm;"><b>City</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-building grey-text" style="font-size: 1rem;"></i></span>
										</div>
									...
									<br> <span style="padding-right: 7.2cm;"><b>State</b><span
										style="color: red;">*</span></span> <br>
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i
												class="fa fa-city grey-text" style="font-size: 1rem;"></i></span>
										</div>
									...
									<font color="red"
										style="padding-right: 5.5cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("state", request)%></font>
									...
									<font color="red"
										style="padding-right: 4.8cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("mobileNo", request)%></font>
